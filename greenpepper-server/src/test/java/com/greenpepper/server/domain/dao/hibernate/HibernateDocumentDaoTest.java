...
public class HibernateDocumentDaoTest extends AbstractDBUnitHibernateMemoryTest
{
    ...
    public void testTheCRUDOfARequirement() throws GreenPepperServerException
    {
    ...
    public void testTheCRUDOfASpecification() throws GreenPepperServerException
    {
        ...
        session.getTransaction().begin();
        Specification specificationToCreate = documentDao.getOrCreateSpecification("SUT-1", "UID-1", "SPECIFICATION-NOT-FOUND");
        session.getTransaction().commit();
        ...
        /*   Creating A Specification Without Specifying A Sut Will Associate The Default Sut  */
        session.getTransaction().begin();
        ...
        /*   Creating A Specification Without Specifying A Sut And No Default Sut Is Defined Will Throw AnException */
        try
        {
            session.getTransaction().begin();
        ...
        {
            assertEquals(GreenPepperServerErrorKey.PROJECT_DEFAULT_SUT_NOT_FOUND, e.getId());
        }     
        ...
        /* An Error Occures If The Sut Doesnt Exists At The Specification Creation */
        try
        {
            session.getTransaction().begin();
    ...
    public void testTheBehaviorOfASpecificationWithinAReference() throws GreenPepperServerException
    {
    ...
    public void testTheBehaviorOfASpecificationAndTheSystemUnderTest() throws GreenPepperServerException
    {
		...
		/* An Error Occures If We Try To Associate A Sut To A None Existing Specification */
        ...
        /* An Error Occures If We Try To Associate A None Existing Sut To A Specification */
		...
		/* An Error Occures If We Try To Deassociate A Sut To A None Existing Specification */
    	systemUnderTest = SystemUnderTest.newInstance("SUT-REFERENCED");
    	systemUnderTest.setProject(Project.newInstance("PROJECT-1"));
    	spec = Specification.newInstance("SPECIFICATION-NOT-FOUND");
    	spec.setRepository(Repository.newInstance("UID-1"));
        ...
        /* An Error Occures If We Try To Deassociate A None Existing Sut To A Specification */
    	systemUnderTest = SystemUnderTest.newInstance("SUT-NOT-FOUND");
    	systemUnderTest.setProject(Project.newInstance("PROJECT-1"));
    	spec = Specification.newInstance("SPECIFICATION-1");
    	spec.setRepository(Repository.newInstance("UID-1"));
        ...
        /* An Error Occures If We Try To Deassociate A Sut From A Specification If Both Are In The Same Reference */
    	systemUnderTest = SystemUnderTest.newInstance("SUT-REFERENCED");
    	systemUnderTest.setProject(Project.newInstance("PROJECT-1"));
    	spec = Specification.newInstance("SPECIFICATION-REFERENCED");
    	spec.setRepository(Repository.newInstance("UID-1"));
    ...
    public void testTheCRUDOfAReference() throws GreenPepperServerException
    {
    	/* We Can  Retrieve A Reference For A Given Specification And Requirement And Sut */
    	...
    	/* Removing The Only Reference Of A Requirement Will Remove The Requirement Also */
    	systemUnderTest = SystemUnderTest.newInstance("SUT-REFERENCED");
    	systemUnderTest.setProject(Project.newInstance("PROJECT-1"));
    	spec = Specification.newInstance("SPECIFICATION-REFERENCED");
    	spec.setRepository(Repository.newInstance("UID-1"));
	...
	public void testTheCreateOfAnExistingReferenceMustDetectDuplicates()
			throws Exception
	{
		/* We Can  Retrieve A Reference For A Given Specification And Requirement And Sut */
		SystemUnderTest systemUnderTest = SystemUnderTest.newInstance("SUT-REFERENCED");
		...
		{
			assertEquals(GreenPepperServerErrorKey.REFERENCE_CREATE_ALREADYEXIST, e.getId());
		}
