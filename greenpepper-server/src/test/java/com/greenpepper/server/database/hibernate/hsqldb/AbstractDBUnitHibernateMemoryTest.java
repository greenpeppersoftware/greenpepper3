...
{
    protected void insertIntoDatabase( String flatXmlDataSetFileName )
            throws Exception
    {
    ...
    protected void deleteFromDatabase( String flatXMLDataSetFileName )
            throws Exception
    {
     ...
     * @throws Exception
     */
    protected void deleteFromDatabase( IDataSet dataSet )
            throws Exception
    {
        IDatabaseConnection connection = null;
        try
    ...
    protected void cleanInsertIntoDatabase( String flatXMLDataSetFileName )
            throws Exception
    {
    ...
    protected void assertTableEquals( Class peristentClass, String[] includedFields, String flatXmlDataSetFileName ) throws Exception
    {
    ...
    private PersistentClass getMapping( Class peristentClass )
    {
        ...
        if ( mapping == null ) throw new AssertionFailedError( "Unable to resolve table name for class: " + peristentClass.getName() );
        return mapping;
    }
