...
{
    public void testThatParametersAreSetterdInTheCommandLineTemplate() throws GreenPepperServerException
    {
        CommandLineBuilder cmd = new CommandLineBuilder("java -mx252m -cp ${classpaths} ${mainClass} ${inputPath} ${outputPath} -l ${locale} -r ${repository} -f ${fixtureFactory} -pdd ${projectDependencyDescriptor} --xml");
